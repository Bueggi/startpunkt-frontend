...
const footerNavigation = {
    ...
    social: [
        ...
        },
        {
            ...
            icon: (props) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <defs xmlns="http://www.w3.org/2000/svg"><linearGradient id="linear-gradient" x1="567.48" y1="-4.48" x2="563.14" y2="513.88" gradientTransform="matrix(1, 0, 0, -1, -309.35, 513.86)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#822cbe" /><stop offset="1" stopColor="#d772fb" /></linearGradient></defs>
                    ...
                    <circle xmlns="http://www.w3.org/2000/svg" className="cls-2" cx="255.74" cy="221.24" r="42.55" />
                    <path xmlns="http://www.w3.org/2000/svg" className="cls-2" d="M260,280.42a83.61,83.61,0,0,1,14.25,2.9,51.55,51.55,0,0,1,14.26,7.13c3.76,2.73,6.49,5.56,8.19,9s2.56,7.54,3.07,14.25c.34,6.72.34,16-1.19,33.44s-4.61,42.79-7,59.08-4.09,23.55-6.31,28.84a25.82,25.82,0,0,1-18.94,16.55,41,41,0,0,1-9.89.85,42.41,42.41,0,0,1-9.9-.85c-3.92-.86-9-2.39-12.8-5.46-3.92-3.07-6.48-7.51-8.53-13.31s-3.58-12.8-5.63-26.79-4.78-34.8-6.48-50.67-2.39-26.79-2.53-34.13.17-11,1-14.5a28.93,28.93,0,0,1,4.09-9.38,31.14,31.14,0,0,1,6.83-7,27.87,27.87,0,0,1,8-4.3A60.8,60.8,0,0,1,241.35,283c4.43-.85,9.55-1.7,12.18-2.05a13.34,13.34,0,0,1,5.56,0Z" transform="translate(-0.14 -0.14)" />
                </svg>
            ),
        },
    ],
