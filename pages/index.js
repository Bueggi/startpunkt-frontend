...
import Header from '@/components/startseite/Header'
import {
  CloudUploadIcon,
  CogIcon,
  LockClosedIcon,
...
import Testimonial from '@/components/startseite/Testimonial'
import CTA from '@/components/startseite/CTA'
import ProblemDefinition from '@/components/startseite/ProblemDefiniton'
import Qualifier from '@/components/startseite/Qualifier'
import FAQ from '@/components/startseite/FAQ'
import Konstantin from '@/components/startseite/Konstantin'
import Pacing from '@/components/startseite/Pacing'
import Framework from '@/components/startseite/Framework'
import Features from '@/components/startseite/Features'
